...
import * as Time from "@demo/utils/.dist/time";
import Joi from "@hapi/joi";
import EventUtil from "@demo/models/.dist/utils/EventUtil";
import BaseService from "@demo/service/.dist/BaseService";
import ConsoleLogManager from "@demo/service/.dist/ConsoleLogManager";
import NatsConnectionManager from "@demo/service/.dist/NatsConnectionManager";
import PbMessageHandler from "@demo/service/.dist/PbMessageHandler";
import PbAsyncMessageHandler from "@demo/service/.dist/PbAsyncMessageHandler";
...
export default class SeatingService extends BaseService {
  ...
  public async isReady(): Promise<boolean>{
    try {
      ...
      this.logger.info(`Service instance ${this.serviceName} is ready...`);
      return true
    } catch (e) {
      this.logger.error(`Service instance ${this.serviceName} is not ready with error ${e.message}`);
      return false;
    }
 }
  public register() {
